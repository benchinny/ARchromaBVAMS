...
C2='rgb'
% C3=[237 125 49; 255 192 0; 112 173 71]./255;
...
for k0=1:length(T0)
    ...
    r=2; c=2; xg0 = [xg0 yx0(r,c)]; hg0 = [hg0 sd0(r,c)];
    r=3; c=2; xb0 = [xb0 yx0(r,c)]; hb0 = [hb0 sd0(r,c)];
    r=2; c=1; yg0 = [yg0 yx0(r,c)]; vg0 = [vg0 sd0(r,c)];
    r=3; c=1; yb0 = [yb0 yx0(r,c)]; vb0 = [vb0 sd0(r,c)];
    yz022=[yz022 -yz0(2,2)]; yz021=[yz021 -yz0(2,1)]; yz032=[yz032 -yz0(3,2)]; yz031=[yz031 -yz0(3,1)];
...
for k0=1:length(T1)
    ...
    r=2; c=2; xg1 = [xg1 yx1(r,c)]; hg1 = [hg1 sd1(r,c)];
    r=3; c=2; xb1 = [xb1 yx1(r,c)]; hb1 = [hb1 sd1(r,c)];
    r=2; c=1; yg1 = [yg1 yx1(r,c)]; vg1 = [vg1 sd1(r,c)];
    r=3; c=1; yb1 = [yb1 yx1(r,c)]; vb1 = [vb1 sd1(r,c)];
    yz122=[yz122 -yz1(2,2)]; yz121=[yz121 -yz1(2,1)]; yz132=[yz132 -yz1(3,2)]; yz131=[yz131 -yz1(3,1)];
...
%     eg0=errorbar(xg0(k0), yg0(k0), vg0(k0), vg0(k0), hg0(k0), hg0(k0), [mrk 'g']); %, 'Color', [0 1 0]./cf);
%     eg0.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('XsysTCA', yz022(k0))
%     eg0.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('YsysTCA', yz021(k0))
%     eg0.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('fnmTCA', {T0(k0)})
%     
%     
%     hold on

%    eb0=errorbar(xb0(k0), yb0(k0), vb0(k0), vb0(k0), hb0(k0), hb0(k0), [mrk C2(C0(k0))]);% 'b']); %, 'Color', [0 0 1]./cf);
    eb0=errorbar(xb0(k0), yb0(k0), vb0(k0), vb0(k0), hb0(k0), hb0(k0), mrk, 'MarkerEdgeColor', C3(C0(k0),:)); %, 'MarkerFaceColor', C3(C0(k0),:));% [mrk C3(C0(k0),:)]);% 'b']); %, 'Color', [0 0 1]./cf);
    eb0.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('XsysTCA', yz032(k0))
    eb0.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('YsysTCA', yz031(k0))
    eb0.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('fnmTCA', {T0(k0)})
    eb0.Color=C3(C0(k0),:); eb0.MarkerSize = 5;
    hold on
...
%     eg1=errorbar(xg1(k0), yg1(k0), vg1(k0), vg1(k0), hg1(k0), hg1(k0), [mrk 'g'], 'MarkerFaceColor','green');
%     eg1.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('XsysTCA', yz122(k0))
%     eg1.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('YsysTCA', yz121(k0))
%     eg1.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('fnmTCA', {T1(k0)})
    
% end
% for k0=1:length(T1)    
    hold on 
    eb1=errorbar(xb1(k0), yb1(k0), vb1(k0), vb1(k0), hb1(k0), hb1(k0), mrk, 'MarkerEdgeColor', C3(C1(k0),:), 'MarkerFaceColor', C3(C1(k0),:)); %[mrk C2(C1(k0))], 'MarkerFaceColor', C2(C1(k0)));
    eb1.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('XsysTCA', yz132(k0))
    eb1.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('YsysTCA', yz131(k0))
    eb1.DataTipTemplate.DataTipRows(end+1)=dataTipTextRow('fnmTCA', {T1(k0)})
    eb1.Color=C3(C1(k0),:); eb1.MarkerSize = 5;
    %hold off
end
