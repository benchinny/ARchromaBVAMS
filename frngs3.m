%%210514 code to run fringe experiment
...
rsd=randperm(8); %[randi(8, 1, ni)];%choose orientation of edge
ni=length(rsd); %number of trials
%bxy=[10 10; 0 0; -10 -10];

bxy0=[0 0; 0 0; 0 0]; %left eye z0 based on LCA values

bxy1=[0 0; 10 10; 20 20]; %left eye z1
...
ni=40; % number of trials
rc00=[0 -8; 4 -7]; % updated april 20 2021, use this
rsd=[randi(8, 1, ni)];%choose orientation of edge
ni=length(rsd); %number of trials
%bxy=[10 10; 0 0; -10 -10];
