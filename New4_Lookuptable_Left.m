    ...
    while true
        ...
        if keyIsDown
            ...
            elseif keyCode(KbName('DownArrow'))
                power=power+0.26;          
            elseif keyCode(KbName('l')) %one
                power=11.0483; mag=1;
            elseif keyCode(KbName('2')) %one
                 power=9.2864; mag=1.2;
            elseif keyCode(KbName('8')) %one
                 power=13.8464; %mag we get is little higher than 0.8 as per the lookup table, but close to 0.8, like 0.81
