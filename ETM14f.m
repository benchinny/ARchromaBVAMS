%% Tumbling E
function [y0 y1 w2 y5]=ETM14f(p0, bxy, bxz, e0, s0, window1, window2);
%bxz = system TCA
...
while opt_chk==0
    ...
    if w1~=w0;
     %% TCA corrected 
     w1=w0; r1=4;
     ir2= embd(circshift(e0{w1, r1, j3(1,1), j3(1,2)}    ,[j1(1,1)-j4(1,1) j1(1,2)-j4(1,2)] ),i255); %window2 LFT screen RED
     ir1= embd(circshift(e0{w1, r1, j3(1,3), j3(1,4)}    ,[j1(1,3)-j4(1,3) j1(1,4)-j4(1,4)] ),i255); %window1 RGT screen RED

     ig2= embd(circshift(e0{w1, r1, j3(2,1), j3(2,2)}    ,[j1(2,1)-j4(2,1) j1(2,2)-j4(2,2)] ),i255); %window2 LFT screen GREEN
     ig1= embd(circshift(e0{w1, r1, j3(2,3), j3(2,4)}    ,[j1(2,3)-j4(2,3) j1(2,4)-j4(2,4)] ),i255); %window1 RGT screen GREEN

     ib2= embd(circshift(e0{w1, r1, j3(3,1), j3(3,2)}    ,[j1(3,1)-j4(3,1) j1(3,2)-j4(3,2)] ),i255); %window2 LFT screen BLUE
     ib1= embd(circshift(e0{w1, r1, j3(3,3), j3(3,4)}    ,[j1(3,3)-j4(3,3) j1(3,4)-j4(3,4)] ),i255); %window1 RGT screen BLUE

%      i3=ct8(ir1, ig1, ib1); %shift TCA right screen
%      i4=ct8(ir2, ig2, ib2); %shift TCA left screen

     i3=cat(3, ir1, ig1, ib1); %shift TCA right screen
     i4=cat(3, ir2, ig2, ib2); %shift TCA left screen
...
%      end
     ...
     if cntrst~=1;
     i30=i3-mxa(i3); i31=cntrst.*i30; i3=i31+mxa(i3);
     i40=i4-mxa(i4); i41=cntrst.*i40; i4=i41+mxa(i4);
     end
    ...
    if keyIsDown
        ...
        disp(['L' n2s2(power_dispL) ' R' n2s2(power_dispR) ' POWER DISPLAY' ' OPT 20/' n2s(s20(w1)) ' ' n2s(w1)])
...
for k0=1:n0; %number of experiments
    ...
    for k1=1:n1    
     ...
     %% TCA UNcorrected 
     jr2= embd(circshift(e0{w1, r1, h3(1,1), h3(1,2)}    ,[h1(1,1)-h4(1,1) h1(1,2)-h4(1,2)] ),i255); %window2 LFT screen RED
     jr1= embd(circshift(e0{w1, r1, h3(1,3), h3(1,4)}    ,[h1(1,3)-h4(1,3) h1(1,4)-h4(1,4)] ),i255); %window1 RGT screen RED

     jg2= embd(circshift(e0{w1, r1, h3(2,1), h3(2,2)}    ,[h1(2,1)-h4(2,1) h1(2,2)-h4(2,2)] ),i255); %window2 LFT screen GREEN
     jg1= embd(circshift(e0{w1, r1, h3(2,3), h3(2,4)}    ,[h1(2,3)-h4(2,3) h1(2,4)-h4(2,4)] ),i255); %window1 RGT screen GREEN

     jb2= embd(circshift(e0{w1, r1, h3(3,1), j3(3,2)}    ,[h1(3,1)-j4(3,1) h1(3,2)-h4(3,2)] ),i255); %window2 LFT screen BLUE
     jb1= embd(circshift(e0{w1, r1, h3(3,3), j3(3,4)}    ,[h1(3,3)-j4(3,3) h1(3,4)-h4(3,4)] ),i255); %window1 RGT screen BLUE
...
%          i4=ct3(ir2); %LEFT
         ...
         i3=cat(3, jr1, jg1, jb1); %shift TCA right screen
         i4=cat(3, jr2, jg2, jb2); %shift TCA left screen
         %i4=i3;
     elseif r0==1;
         %i3=ct8(ir1, ig1, ib1); %shift TCA right screen
         %i4=ct8(ir2, ig2, ib2); %shift TCA left screen
...
%      end
     ...
     [i3f i4f]=cwin3(i3, i4, cf, rc00, window1, window2);
   ...
   zaber(name_map('rotation')).control.getposition              0];
    ...
    save('data\ETMtmp.mat', 'y1', 'w2', 'y0', 'k0', 'y5', 'i3f', 'i4f');
    %sz=1; sn=10004;
