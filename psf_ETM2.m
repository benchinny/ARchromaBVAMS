%210705 psignfit for individual ETM staicases
function [r00 r11]=psf_ETM2(y0, y1, w2, d1);

y01=y1; y1(:,1:d1)=[];
w02=w2; w2(:,1:d1)=[];

r0=zeros(4,5); r1=r0; s0=[]; s1=[]; l0=[]; l1=[];
for k0=1:length(y0);
    r01=psfe2(y0(k0), y1(k0,:), w2(k0,:), 0, d1); %210705
    if y0(k0)==0
...
r00=[r00; [100 r00(1,5)-std(l0,0) r00(1,4)-std(s0,0) r00(1,4)+std(s0,0) r00(1,4)+std(l0,0)]];
r00(1,2)=numel(y01(y0==0,:)); r00(1,3)=numel(y1(y0==0,:));

r11=r1./sum(y0==1); r11(1,1)=1;
r11=[r11; [100 r11(1,5)-std(l1,0) r11(1,4)-std(s1,0) r11(1,4)+std(s1,0) r11(1,4)+std(l1,0)]];
