...
for k0=1:length(focStmOptDstIncrAll)
      ...
      acuStimOrig1 = insertShape(zeros([sizeTotal sizeTotal 3]), 'FilledCircle', [stimCtr stimCtr-offsetYall(k0) stimSizePixAll(k0)], 'Color',rgbAll(k0,:));
      acuStimOrig1 = insertShape(acuStimOrig1, 'FilledCircle',                   [stimCtr+offsetXall(k0) stimCtr+offsetYall(k0) stimSizePixAll(k0)], 'Color',rgbAll(k0,:));
      acuStimOrig2 = insertShape(zeros([sizeTotal sizeTotal 3]), 'FilledCircle', [stimCtr stimCtr-offsetYall(k0) stimSizePixAll(k0)], 'Color',rgbAll(k0,:));
      acuStimOrig2 = insertShape(acuStimOrig2, 'FilledCircle',                   [stimCtr-offsetXall(k0) stimCtr+offsetYall(k0) stimSizePixAll(k0)], 'Color',rgbAll(k0,:));
