...
% focStmOptDst = [1.25 1.25 1.25 1.25 -1.25 -1.25 -1.25 -1.25]';
% meanFocstmOptDst = 1.*[4.375 4.375 4.375 4.375 4.375 4.375 4.375 4.375]';
% rgb2 = [0.62 0.00 1.00; ...
%         0.62 0.00 1.00; ...
%         0.62 0.00 1.00; ...
%         0.62 0.00 0.00; ...
...
%         0.00 0.00 1.00; ...
%         0.00 0.00 1.00];
% AFCv = [1:8 fliplr(1:8) 1:8 fliplr(1:8)]';
% focStmOptDst = [1.25 1.25 1.25 -1.25 -1.25 -1.25]';
% meanFocstmOptDst = 1.*[4.375 4.375 4.375 4.375 4.375 4.375]';
% rgb2 = [0.62 0.39 1.00; ...
%         0.62 0.39 1.00; ...
%         0.62 0.39 1.00; ...
%         0.62 0.39 1.00; ...
...
%         0.62 0.00 1.00; ...
%         0.62 0.39 0.00];
% AFCv = [1:6 fliplr(1:6) 1:6 fliplr(1:6)]';
% focStmOptDst = [1];
...
%         0.37 0.00 0.00; ...
%         0.62 0.00 0.00];
% AFCv = [1:8 fliplr(1:8) 1:8 fliplr(1:8) 1:8]';
...
rgb2 = [0.62 0.00 0.00; ...
        ...
        0.00 0.39 0.00; ...
        0.00 0.00 1.00];
AFCv = [1:6 fliplr(1:6) 1:6 fliplr(1:6) 1:6]';
