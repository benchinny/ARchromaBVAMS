...
function ARCtestWvInFocusMeanZstrehlLMSeffectFitOnly(subjNum,wS)
...
save([coneWeightsFolder 'S' num2str(subjNum) 'wvInFocusModelResultsStrehl' num2str(round(-wS*10)) '.mat'],'RMSEall','wS','wLM','wLprop');
