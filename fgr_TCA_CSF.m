...
for k0=1:length(T0)
    ...
    hold on
    eb0=errorbar(xb0(k0), yb0(k0), vb0(k0), vb0(k0), hb0(k0), hb0(k0), [mrk 'b']); %, 'Color', [0 0 1]./cf);
...
% for k0=1:length(T1)    
    hold on
    eb1=errorbar(xb1(k0), yb1(k0), vb1(k0), vb1(k0), hb1(k0), hb1(k0), [mrk 'b'], 'MarkerFaceColor','blue');
