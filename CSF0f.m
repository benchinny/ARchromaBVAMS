...
function [r2 c2]=CSF0f(ni, n4, f, s, d0, a0, s2, window1, window2);
...
clear r2 c2
for k2=1:length(s2)
    d1=1; r0=zeros(1,ni); r1=0;%initial contrast
    for n=1:ni
        if d1>1; d1=1; elseif d1<=0; d1=0; end; % make sure contrast is between 0 and 1
        if  d1>=1;
            i2=i1;
        else
