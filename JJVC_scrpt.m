...
p0(3,:)=[16                 16];              %power_dispL_max      power_dispL_max                   
...
%             LCAtromPowerR=p3(5,1); %added by swati on feb 21 2021 %trueonly if power is within the limits!!!!!
%             fprintf('\nRight Trombone optotune power for LCA correction %.4f \n', LCAtromPowerR);
...
%             LCAtromPowerL=p3(5,1);%added by swati on feb 21 2021
%             fprintf('\nLeft Trombone optotune power for LCA correction %.4f \n', LCAtromPowerL);
            p4=[p3 p0(:,2)]; 
