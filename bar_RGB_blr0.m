...
ext=false;     chk=0;
    ...
    r=0; b=0; cnt=1; % set intial position of red background and vertical bar
...
%      for k0=1:sz0(1); i0(k0, k0)=255; end;
     ...
     ir00=imgaussfilt(ir0, s); ig00=imgaussfilt(ig0, s); ib00=imgaussfilt(ib0,s);
     img=uint8(cat(3, ir00, ig00, ib00));
     vout= [  ir00(1,:); ig00(sz2(1),:); ib00(end,:)];
    ...
    save(['RGB_' num2str(cnt)], 'b', 'ms', 'vout'); cnt=cnt+1;
