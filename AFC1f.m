%%211109 AFC1f 
function v1=AFC1f(im_path, v0, window1, window2)
...
if scene.enable_tcp; send_tcp0(scene, 1); end %stage) 0stop 1record figure this out with Steve
...
%           snd(2000, 0.25);  %pause(2.75);
     ...
     if k0==38; send_tcp0(scene, 0); KbWait([], 2); send_tcp0(scene, 1); end
