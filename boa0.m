...
cl=[1 2 3]; %background color 0white 1red 2green 3blue choose background color
tm=[0.8     1       1.2]; % thrombone mag setting
opto_power=@(mag) -9.9976*mag+21.164;
tp=[opto_power(0.8) opto_power(1) opto_power(1.2)]; %thrombone power setting
...
[window1, window2, vbl0]=strt_psych(screenNumber-1, screenNumber, ex); 
        ...
        %presented in command window: trial #, base-power, stroke size, optotype size, time to generate optotype 
                ...
                [p12 rvc wvc zzc wn]=boaii([n, w, dly, sd, drp], p00(1:18, :), bxy, ey, window1, window2);
