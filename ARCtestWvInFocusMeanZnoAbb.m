...
defocus875predAll = [];
wvInFocusAll = [];
savePath = '/Users/benjaminchin/Library/CloudStorage/GoogleDrive-bechin@berkeley.edu/Shared drives/CIVO_BVAMS/data/coneWeightsErrorNoAbb/';
    ...
    for i = 1:length(wLunq)
        for j = 1:length(wMunq)
            ...
            parfor l = 1:size(rgbUnq,1)
                wvInFocus(l,:) = ARCwvInFocusConesMeanZnoAbb(subjNum,l,[wL wM wS]);
