...
% %        LEFT      RIGHT
% p0(2,:)=[11.2718    14.09]; %ar right Feb 1 2021
% p0(5,:)=[9.3665   9.2388]; % setting it ot the limit
...
% p0(5,:)=[13.8    13.1]; %RIGHT DISP TCA Adjustment opto power 3, 13.1D
% p0(5,:)=[8.7   13.1]; %RIGHT DISP TCA Adjustment opto power 3, 13.1D
nL=1;
nR=1;
...
p0(5,:)=[LTrompows(nL)             RTrompows(nR)];
% 
...
flagL=0;
if(trombone_power_left>=opL(1.2) && trombone_power_left<=opL(0.8))
    fprintf('In above matrix, LEFT trombone power is within the limits of 0.8 and 1.2 magnification\n');
...
elseif trombone_power_left<opL(1.2) && trombone_power_left>opL(1.3)
    fprintf('In above matrix, LEFT SIDE Mag is higher than 1.2,BUT Less than 1.3 (beam size is still less than 5.2 at ACL\n');
else
...
fprintf('\n');
flagR=0;
if(trombone_power_right>=opR(1.2) && trombone_power_right<=opR(0.8))
    fprintf('In above matrix, RIGHT trombone power is within the limits of 0.8 and 1.2 magnification\n');
elseif trombone_power_right<opR(1.2) && trombone_power_right>opR(1.3)
    
    fprintf('In above matrix, RIGHT Mag is higher than 1.2,BUT Less than 1.3 (beam size is still less than 5.2 at ACL\n');
else
