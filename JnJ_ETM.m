...
%cf=[0.6267 0.6153; 0 0; 0 0]; n0=4; cg='p';  %210621 gamma corrected/purple background
%cf=[0 0; 0.4279 0.3982; 0 0]; n0=4; cg='p';  %210621 gamma corrected/purple background
%cf=[0 0; 0 0; 1 1]; n0=4; cg='p';  %210621 gamma corrected/purple background
...
if sv == 1;
    ...
    save(ETMfls0, 'ETMp'); 
    load(['JnJ\ETMfls' ey(1) '.mat'], 'ETMfls'); ETMfls{sn-1000,vs}=ETMfls0; save(['JnJ\ETMfls' ey(1) '.mat'], 'ETMfls'); 
end
