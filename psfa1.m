...
%% 210518 implement psignfit on multiple trial/repetition data 
 function [r0 r1]=psfa1(y0, y1, w2, d0, s0)
% y0 TCA1
...
plotOptions.xLabel         = 'Snellen Acuity 20/'; % X-Axis label
...
%        title(['ALL TCA1 @78.1%=' n2s2(r2)  ' VA=20/'  n2s2(20.*r2./c1)]); disp(20.*r2./c1); disp(20.*CI./c1);
        title(['ALL TCA1 VA@78.1%=20/' n2s2(r2)]); disp(r2); disp(CI);
        ...
        title(['ALL TCA0 VA@78.1%=20/' n2s2(r2)]); disp(r2); disp(CI);
