%% Tumbling E
%% use base2 -2 to 10 log base
function [rv wv wn]=ETM6f(n, bxy, dly, ey, window1, window2);
...
%         i0=double(Ec{w, p(ni)+1});
        ...
        if p(ni)==0; st=dk; elseif p(ni)==1; st=lk; elseif p(ni)==2; st=uk; elseif p(ni)==3; st=rk; end 
...
%       i2=cat(3, i1, i0, i0);
   ...
   wn=cwin0(i2, ey, cf, rc00, window1, window2);     disp([wv0(w) 2.^(wv0(w)./2) p(ni)+1]);
