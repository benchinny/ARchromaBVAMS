%%210702 function to run fringe experiment

function [rsp rsd]=FRNG4f(p0, bxy0, bxy1, e0, s0, window1, window2)
...
cntrst=1;
w00=fcs_opt(w0, j4, j3, j2, j1, i255, e0, s0, window1, window2); 
...
while n<=ni 
    chk_rpt=0;
     ...
     ib0= embd(circshift(e0{w1, r1, h3(3,1), h3(3,2)}    ,[h1(3,1)-h4(3,1) h1(3,2)-h4(3,2)] ),i255); %window2 LFT screen BLUE
...
% 
     ...
     save(['data\FRNGtmp'], 'bxy0','bxy1', 'rsp', 'rsd', 'i2f','FRNGi', 'im0', 'im1', '');
