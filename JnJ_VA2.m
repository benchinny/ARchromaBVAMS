...
%cf=ones(3,2); cf(:,1)=0;
      ...
      %    !!!!!!!!!!!!!! UPDATE TCA and LCA files!!!!!!!!!!!!!!
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
        %load TCA file
        TCAfnm='S10102Left_TCA_ACL1_2112211057.mat'; load(TCAfnm, 'TCAp');
%          load('.mat', 'TCAp');
        z0L=TCAp.sysTCA; z1L=TCAp.sbjTCA; TCAfnmL=TCAfnm;
%         z0L=[0 0; -10 -10; 10 10]; z1L=z0L;
%         z0L=[0 0; 0 0; 0 0]; z1L=z0L;

        TCAfnm='S10102Right_TCA_ACL1_2112211104.mat'; load(TCAfnm, 'TCAp');
%          load('.mat', 'TCAp');
...
%          z0R=[0 0; -10 -10; 10 10]; z1R=z0R;
 ...
 %NOTE: NEED TO SELECT APPROPRAITE VALUE OF ACL for findz0 to work
        ...
        [y1 w2 y5]=ETM18f([n0 n1 w0 d0 tcaCorrect], y0, z1R, z0R, z1L, z0L, E10c, STK, window1, window2);
