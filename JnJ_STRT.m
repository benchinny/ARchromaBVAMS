...
addpath([pwd '\fcns']); addpath('G:\My Drive\exp_bvams\code_repo\imgs\'); addpath([pwd '\apps']); addpath([pwd '\toolboxes']); addpath([pwd '\psignifit-master']); addpath([pwd '\data\System TCA\Data Processing']);  addpath(genpath(fullfile('toolboxes')));
cls
