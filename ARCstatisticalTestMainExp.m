...
glmeGreenless = fitglme(dataTableGreenless,'MeanD ~ ColorRatio + OpticalDistance + (1|Subject)', ...
    'Distribution','Normal','Link','identity');

glmeGreen = fitglme(dataTableGreen,'MeanD ~ ColorRatio + OpticalDistance + (1|Subject)', ...
    'Distribution','Normal','Link','identity');
