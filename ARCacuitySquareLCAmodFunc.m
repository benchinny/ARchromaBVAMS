function AFCp = ARCacuitySquareLCAmodFunc(imPattern,rgb,meanFocstmOptDst,focStmOptDstIncr, cAcuRGB, window1, window2, trlPerLvl, vs)
...
for k0=1:length(focStmOptDstIncrAll)
      ...
      acuStimOrig1 = ARC2Dgabor(smpPos(256,256),[],0,0,[frqCpd frqCpd*3 frqCpd*5 frqCpd*7],[cAcuRGB(indAcuRGB) cAcuRGB(indAcuRGB)/3 cAcuRGB(indAcuRGB)/5 cAcuRGB(indAcuRGB)/7],-15,90,0.2,0.2,[rgbAcuRGB(indAcuRGB,1)^gammaR rgbAcuRGB(indAcuRGB,2)^gammaG rgbAcuRGB(indAcuRGB,3)^gammaB],1,1,0,0);
      acuStimOrig1(:,:,1) = acuStimOrig1(:,:,1).^(1/gammaR);
      acuStimOrig1(:,:,2) = acuStimOrig1(:,:,2).^(1/gammaG);
      acuStimOrig1(:,:,3) = acuStimOrig1(:,:,3).^(1/gammaB);
      acuStimOrig2 = ARC2Dgabor(smpPos(256,256),[],0,0,[frqCpd frqCpd*3 frqCpd*5 frqCpd*7],[cAcuRGB(indAcuRGB) cAcuRGB(indAcuRGB)/3 cAcuRGB(indAcuRGB)/5 cAcuRGB(indAcuRGB)/7],15,90,0.2,0.2,[rgbAcuRGB(indAcuRGB,1)^gammaR rgbAcuRGB(indAcuRGB,2)^gammaG rgbAcuRGB(indAcuRGB,3)^gammaB],1,1,0,0);
...
AFCp.indAcuRGBall = indAcuRGBall;
AFCp.cAcuRGB = cAcuRGB;
AFCp.frqCpd = frqCpd;
