...
for i = 1:size(rgbUnq,1)
    ...
    [mFit,sFit,bFit,Tfit,PCdta,PCfit,negLL] = psyfitgengauss(zeros(size(AFCpAll.contrast(ind))),AFCpAll.contrast(ind),AFCpAll.rspAcu(ind)==AFCpAll.stimOrientation(ind),[],[],[],1.48,2,0);
    if subjNum==13
