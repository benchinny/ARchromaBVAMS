%%211212 JJVC_LCA run LCA for JnJ subjects includes half LCA calculation
ex='LCA';
...
[window1, window2, vbl0]=strt_psych0(screenNumber-1, screenNumber, 0);
        ...
        [a10, a11, a12, a13, a14, a15, a16, a17, a18, a19]=LCA15f(LCAim, a0, window1, window2); %p1(a10):data, p2:avg, p3:sd, (a13)p4:sys+eye, p5(a14):EyeLCA, p6:trom pwr
