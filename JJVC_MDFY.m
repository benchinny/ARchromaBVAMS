...
%Initialize powers
power_dispL=a18(2,1);
if ACL==0 powerL=opL(1); elseif ACL==1; powerL=a18(5,1); elseif ACL==2; powerL=a19(5,1); end
deg=-3; 
...
%Initialize powers
power_dispR=a18(2,2) ;
if ACL==0; powerR=opR(1); elseif ACL==1; powerR=a18(5,2); elseif ACL==2; powerR=a19(5,2); end
