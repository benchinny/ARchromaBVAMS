%%210622 Tumbling E
function [y0 y1 w2 y5]=ETM15f(p0, bxy, bxz, e0, s0, window1, window2);
%bxz = system TCA
...
for k0=1:n0; %number of experiments
    ...
    for k1=1:n1    
     ...
     jb0= embd(circshift(e0{w1, r1, h3(3,1), j3(3,2)}    ,[h1(3,1)-j4(3,1) h1(3,2)-h4(3,2)] ),i255); %window2 LFT screen BLUE
     

     if r0==0

         im0=cat(3, jr0, jg0, jb0); %shift TCA right screen
         im2=im0;
