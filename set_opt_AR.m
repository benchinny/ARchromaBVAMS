...
% p0(1,:)=[8                    8];               %power_dispL_min      power_dispR_min
% p0(2,:)=[9.34609     14.587525 ]; %power_dispL 11.27175          power_dispR  12.80192 
% p0(3,:)=[25                   25];              %power_dispL_max      power_dispL_max                   
% p0(4,:)=[opL(0.8)             opR(0.8)];        %L_optopower(mag)_min R_optopower(mag)_min         
% p0(5,:)=[8.7837              8.9288];          %L_optopower(mag)     R_optopower(mag)     
% p0(6,:)=[opL(1.2)             opR(1.2)];        %L_optopower(mag)_max R_optopower(mag)_max
...
%MB nov 25th
% p0=[p4 p3] either use this or use the following
...
p0(6,:)=[opL(1.2)             opR(1.2)];        %L_optopower(mag)_max R_optopower(mag)_ma   x
p0(7,:)=-3; %rotation
...
p0(2,:)=[  14.379142    14.379142  ]; %power_dispL 11.27175          power_dispR  14.379142 ,14.7791421,14.679142
