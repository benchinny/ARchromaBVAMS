%% Version 220416
%clr
global ek uk dk lk rk st snt  black white grey screenXpixels screenYpixels xCenter yCenter ifi zbr cf Ec sz E10c rc00
% edit JJVC_stro
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%UPDATE1: LOAD CORRECT LCA FILE with ACL=0: FOR getting SYSTEM TCA%%%%%%%
...
% load('S10003_LCA_RightACL0_2104301024.mat', 'a18'); a18R=a18; %RIGHT LCA ar used on april 30
% load('S10003_LCA_LeftACL0_2104301034.mat', 'a18');a18L=a18; %LEFT LCA ar used on april 30
...
% z0=zeros(3,4);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%UPDATE 2:LOAD CORRECT SUBJECT+SYSTEM TCA FILE FOR RESPECTIVE EYE and ACL condition%%%%%
%change the below TCA file depending on ACL=0 or ACL=1 and which Eye you're doing
%acuity on
% load('S10003_TCA_RightACL1_2104301234.mat', 'z1');% used on APril 30 AR with ACL
%load('S10003_TCA_RightACL0_2104301055.mat', 'z1'); % used on APril 30 AR without ACL
% load('S10007_TCA_LeftACL1_CAm2104191224.mat', 'z1');
% load('S10007_TCA_LeftACL1_Cam2104191252.mat', 'z1');
 load('S10004_TCA_LeftACL1_2104301431.mat', 'z1');
...
% load('S10007_TCA_RightACL1_2104221154.mat', 'z1'); %nadav april 22 acl=1
%%%%%%%%%%%%%CHECK RETICLE%%%%%%%%%%%%%%
