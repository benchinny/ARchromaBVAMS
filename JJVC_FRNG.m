%%210517 code to run fringe experiment input m output n
...
%  load('S10004_LCA_LeftACL0_2104061444.mat', 'a18'); %LOAD LCA 
...
load('S10003Right_TCA_ACL1_2106111624.mat', 'z1'); %LOAD TCA AR June 11

% load('S10003Right_TCA_ACL0_2106111415_corrected0.mat', 'z1'); %LOAD TCA AR June 11
...
VRCMprm;
save(['data\S' num2str(sn) ey '_' ex '_ACL' n2s(ACL) '_' tme], 'n0', 'm0', 'bxy0', 'bxy1', 'VRCMp');
