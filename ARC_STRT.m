...
addpath([pwd '\fcns']); addpath('H:\Shared drives\CIVO_BVAMS\code\imgs\'); addpath([pwd '\apps']); addpath([pwd '\toolboxes']); addpath([pwd '\psignifit-master']); addpath(['H:\Shared drives\CIVO_BVAMS\data\System TCA\Data Processing\']);  addpath(genpath(fullfile('toolboxes')));
cls
